...
class StudentMemory:
    ...
    def retrieve_long_term(self, user_id: str, thread_id: str, query: str) -> str:
        ...
        # Context Block is the primary source. Edge search adds inspectable
        # provenance/validity and makes open-loop and conflict cases less
        # sensitive to the generated Context Block wording.
        try:
            ...
            # A Context Block is still useful if an SDK/account does not expose
            # edge search. Do not turn that optional audit path into a hard fail.
            facts = ""
