...
The page shell, budget metrics, Gemini chat, and layered student retrieval are
wired end to end.
...
def retrieve_for_case(
    ...
    # Recreate the same short-term view as the evaluator, then append turns
    # entered in the UI so follow-up chat keeps a compact thread-local history.
